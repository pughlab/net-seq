...
###################
#### VARIABLES ####
mut.table <- read.csv("~/git/net-seq/CN-LOH_plots/data/pnet_mutations.csv",
                      header=TRUE, stringsAsFactors = FALSE, check.names = FALSE)
load("~/git/net-seq/CN-LOH_plots/data/chromInfo.Rdata")
load("~/git/net-seq/CN-LOH_plots/data/data.aggregateLoh.pnets.Rdata")
load("~/git/net-seq/CN-LOH_plots/data/genie_cn.Rdata")
load("~/git/net-seq/CN-LOH_plots/data/genie_mut.Rdata")
